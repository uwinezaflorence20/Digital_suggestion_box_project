      ...
      <div className="mx-auto bg-white max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="lg:py-24">
            ...
            <p
              onMouseEnter={() => handleHover("DS-Box is an online platform designed for the University of Rwanda College of Science and Technology to collect, manage, and respond to suggestions from students, staff, and faculty.")}
